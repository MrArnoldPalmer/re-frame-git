...
(register-handler :process-repo-languages-response repo-handlers/process-repo-languages-response repo-is-loaded)
(register-handler :get-repo-branches repo-handlers/get-repo-branches)
(register-handler :process-repo-branches-response repo-handlers/process-repo-branches-response repo-is-loaded)
(register-handler :get-repo-tree repo-handlers/get-repo-tree)
(register-handler :process-repo-tree-response repo-handlers/process-repo-tree-response repo-is-loaded)
